...
// @require
// ==/UserScript==
/* global define,ghImport,RelativeTimeElement,$,TimeAgoElement,LocalTimeElement */
setInterval(function(){//重复执行
   ...
   */
    ...
    I18N.zh = {
       ...
       * 相对时间格式处理
       */
                [/just now|yesterday|(an?|\d+) (second|minute|hour|day|month|year)s? ago/, function (m, d, t) {
                    if (m === 'just now') {
                        return '刚刚';
                    }
                    if (m === 'yesterday') {
